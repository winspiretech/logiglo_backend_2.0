...
router.get("/getdraftquotepostsbyuserid/:userId", quotePostController.getDraftPosts);
...
router.get("/getquotepostsbyuserid/:userId", quotePostController.getPostsByUserId);

// Fetch all QuoteReplies for a specific successful QuotePost
router.get("/getquotereplybypostid/:postId", quotePostController.getRepliesByPostId);

// Fetch the like count and user like status for a specific QuotePost
router.get("/getquotelikecountbypostid/:postId", quotePostController.getLikesByPostId);

// Fetch a specific QuotePost by postId
router.get("/getquotepostbypostid/:postId", quotePostController.getQuotePostByPostId);
